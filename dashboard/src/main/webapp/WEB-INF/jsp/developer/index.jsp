                    ...
                    <c:when test="${app != null}">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <a href="<c:url value="/developer/db/create" />" class="btn btn-primary btn-block">Create database</a>
                            </c:otherwise>
                        </c:choose>
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <a href="<c:url value="/developer/auth/create" />" class="btn btn-primary btn-block">Create authentication credentials</a>
                            </c:otherwise>
                        </c:choose>
                        <h1>Deployment</h1>
                        <a href="<c:url value="/developer/upload" />" class="btn btn-primary btn-block">Deploy your application</a>
                    </c:when>
                    <c:otherwise>
                        <h1>You have not created an application:</h1>
                        <a href="<c:url value="/developer/create" />" class="btn btn-primary btn-block">Create application</a>
                    </c:otherwise>
                </c:choose>
            </div>
        </div>
