...
<main role="main" class="container">
    ...
    <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-blue rounded shadow-sm">
        ...
        <div class="lh-100">
            <h6 class="mb-0 text-white lh-100">Viewing Lisiting for </h6>
    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        <form:form method="POST"
                   action="/comment/add" modelAttribute="comment">
            <form:label path="comment">Comment:</form:label><br>
            <form:input path="comment"/><br>
            <form:input path="user" type="hidden" value="${listing.user.id}"/>
            <form:input path="listing" type="hidden" value="${listing.id}"/>
